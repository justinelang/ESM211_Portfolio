---
title: "Portfolio 5 Part 2: Kernels"
author: "Justine Lang"
date: "2024-01-30"
output: 
  html_document: 
...
Each elk herd in the GYE is bizarrely unique, and their movement often depends on the feedground they are associated with if they are a fed herd. Inspecting the graphs and data is the best way to tell which method best suits the individual elk or herds you're interested in. For these six elk, several do not have the "dip" in the LSCV graphs, which suggests that the reference bandwidth method might be better in this instance, but that might not always be the case. 
...
Most of the elk in the same herd have the same home range and migration patterns, which make sense. On the NER in particular, the elk stay clustered together throughout much of the feeding season. Elk from other smaller feedgrounds, however, don't necessarily maintain the same high density throughout their home range. 
